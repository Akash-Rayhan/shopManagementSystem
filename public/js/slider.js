...
// Initialize slider:
function activateQuantitySlider(range){
    $('.noUi-handle').on('click', function() {
        $(this).width(50);
    });
    var quantityRangeSlider = document.getElementById('quantity-slider-range');
...
function activatePriceSlider(range){
    $('.noUi-handle').on('click', function() {
        $(this).width(50);
    });
    var priceRangeSlider = document.getElementById('price-slider-range');
    var moneyFormat = wNumb({
        decimals: 0,
        thousand: '',
    });
